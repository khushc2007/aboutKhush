...
const statements = [
  "Silicon thinks in electrons, I think in systems.",
  "Every gate delay is a design decision.",
  "Hardware is just philosophy made physical.",
  "Timing is not a constraint — it is the art.",
  "The chip is the canvas. Logic is the brush.",
]
