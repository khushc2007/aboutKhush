...
const techItems = [
  "VERILOG", "NEXT.JS", "SPICE", "PYTHON", "RTL DESIGN",
  "TYPESCRIPT", "CMOS", "NODE.JS", "SYNTHESIS", "RUST",
]

const concepts = [
  "TIMING CLOSURE", "ARCHITECTURE", "PLACE & ROUTE", "SYSTEMS",
  "SIGNAL INTEGRITY", "ALGORITHMS", "POWER ANALYSIS", "EMERGENCE",
  "LAYOUT", "LATENCY", "TESTBENCH", "PRECISION",
]
    ...
    <div className="relative overflow-hidden py-4">
      ...
      >
        {duplicatedItems.map((item, index) => (
          <span
            key={index}
            className="group font-sans text-3xl md:text-7xl lg:text-8xl font-light tracking-tight whitespace-nowrap cursor-default"
            style={{
